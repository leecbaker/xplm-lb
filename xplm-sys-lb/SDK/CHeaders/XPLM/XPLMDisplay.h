 ...
 *
 */
typedef enum XPLMCursorStatus (* XPLMAvionicsCursor_f)(
                         int                  x,
                         int                  y,
                         void *               inRefcon);
#endif /* XPLM410 */
 ...
 *
 */
typedef enum XPLMCursorStatus (* XPLMHandleCursor_f)(
                         XPLMWindowID         inWindowID,
                         int                  x,
                         int                  y,
                         void *               inRefcon);
...
typedef struct {
     ...
     * window, if any                                                             */
     enum XPLMWindowDecoration decorateAsFloatingWindow;
#endif /* XPLM301 */
#if defined(XPLM300)
 ...
 *
 */
enum XPLMWindowPositioningMode: int{
...
XPLM_API void       XPLMSetWindowPositioningMode(
                         XPLMWindowID         inWindowID,
                         enum XPLMWindowPositioningMode inPositioningMode,
                         int                  inMonitorIndex);
#endif /* XPLM300 */
