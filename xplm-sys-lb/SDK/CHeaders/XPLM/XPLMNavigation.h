...
XPLM_API XPLMNavRef XPLMFindNavAid(
                         ...
                         const float *        inLat,                  /* Can be NULL */
                         const float *        inLon,                  /* Can be NULL */
                         const int *          inFrequency,            /* Can be NULL */
                         enum XPLMNavType     inType);
...
XPLM_API void       XPLMGetNavAidInfo(
                         XPLMNavRef           inRef,
                         enum XPLMNavType *   outType,                /* Can be NULL */
 ...
 *
 */
typedef enum XPLMNavFlightPlan {
...
XPLM_API int        XPLMCountFMSFlightPlanEntries(
                         enum XPLMNavFlightPlan    inFlightPlan);
#endif /* XPLM410 */
...
XPLM_API void       XPLMGetFMSFlightPlanEntryInfo(
                         ...
                         enum XPLMNavType *   outType,                /* Can be NULL */
                         char *               outID,                  /* Can be NULL */
                         enum XPLMNavRef *    outRef,                 /* Can be NULL */
                         int *                outAltitude,            /* Can be NULL */
                         float *              outLat,                 /* Can be NULL */
                         float *              outLon);                /* Can be NULL */
#endif /* XPLM410 */
 ...
 *
 */
XPLM_API enum XPLMNavType XPLMGetGPSDestinationType(void);
