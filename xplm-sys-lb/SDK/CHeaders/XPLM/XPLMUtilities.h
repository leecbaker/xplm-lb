...
XPLM_API int        XPLMLoadDataFile(
                         enum XPLMDataFileType inFileType,
 ...
 *
 */
enum XPLMHostApplicationID: int{
    xplm_Host_Unknown                        = 0,
...
XPLM_API void       XPLMGetVersions(
                         ...
                         int *                outXPLMVersion,
                         enum XPLMHostApplicationID * outHostID);
 ...
 *
 */
XPLM_API enum XPLMLanguageCode XPLMGetLanguage(void);
 ...
 *
 */
typedef enum XPLMCommandButtonID {
          xplm_joy_nothing=0,
          xplm_joy_start_all,
          xplm_joy_start_0,
          xplm_joy_start_1,
...
XPLM_API void       XPLMCommandButtonPress(
                        enum XPLMCommandButtonID  inButton);
